        ...
        ApiService.addVotes({ issuesId: issueId })
            .then((res) => {
                if (res.data.success) {
                    ...
                    toast.error(res.data.message); // already liked
                }
            })
            .catch((err) => {
                toast.error(err.message);
                                        ...
                                        <div className="event-item"  >
                                            <div className="event-header">
                                                <div
                                                    ...
                                                    style={{
                                                        cursor: el.status === "Resolved" ? "not-allowed" : "pointer",
                                                        opacity: el.status === "Resolved" ? 0.6 : 1
                                                    }}
                                                    onClick={() => {
                                                        if (el.status === "Resolved") {
                                                            toast.error("Voting is closed for resolved issues")
                                                        } else {
                                                            upVoteIssue(el._id)
                                                        }
                                                    }}
